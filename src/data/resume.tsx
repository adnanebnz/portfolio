...
export const DATA = {
  ...
  featuredProjects: [
    ...
    },
    {
      ...
      slug: "smartclean",
      subtitle: {
        en: "Enterprise cleaning services management platform with multi-platform support",
        fr: "Plateforme de gestion de services de nettoyage d'entreprise avec support multi-plateforme",
      },
      keyFeatures: {
        en: {
